                ...
                <div className="header__dropdown-menu" ref={dropdownMenuRef} id="dropdownMenu" style={{ display: "none" }}>
                    <ul className="header__expanded-menu">
                        <li className="header__expanded-menu-item">
                            <box-icon className= "header__dropdown-icon" type="logo" name="baidu" color="#575756" style={{ width: "30px", height: "30px" }} ></box-icon>
                            <a className='header__expanded-menu-a' href="adopciones">Adopciones</a>
                        </li>
                        <li className="header__expanded-menu-item">
                            <box-icon className= "header__dropdown-icon" name="donate-heart" color="#575756" style={{ width: "30px", height: "30px" }} ></box-icon>
                            <a className='header__expanded-menu-a' href="donaciones">Donaciones</a>
                        </li>
                        <li className="header__expanded-menu-item">
                            <box-icon className= "header__dropdown-icon" name="home-heart" color="#575756" style={{ width: "30px", height: "30px" }} ></box-icon>
                            <a className='header__expanded-menu-a' href="nosotros">Nosotros</a>
                        </li>
                        <li className="header__expanded-menu-item">
                            <box-icon className= "header__dropdown-icon" type="solid" name="contact" color="#575756" style={{ width: "30px", height: "30px" }} ></box-icon>
                            <a className='header__expanded-menu-a' href="contáctanos">Contáctanos</a>
                        </li>
                    </ul>
                </div>
            </div>
